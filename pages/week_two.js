    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', width: '100%', marginTop: '0px' }}>
      ...
      <div className={styles.subcard1}>
        ...
        <div className={styles.subcard2}>
          ...
          <img style={{ width: '20%', height: '20%' }} src="bottle.png" alt="Website Image" />
          <img style={{ width: '25%', height: '25%' }} src="cup.png" alt="Website Image" />
      </div>
      <div className={styles.subcard2}>
          <p>
          ...
          <p>
            ...
            <img style={{ width: '50%', height: '50%' }} src="box.png" alt="Website Image" />
            <img style={{ width: '20%', height: '20%' }} src="box_real.png" alt="Website Image" />
          ...
          <img style={{ width: '50%', height: '50%' }} src="param_box.png" alt="Website Image" />
          <img style={{ width: '30%', height: '30%' }} src="param_box_real.png" alt="Website Image" />
      </div>
      <div className={styles.subcard2}>
        <p>Lastly, I crafted my own unique press-fit shapes! One of the reasons I appreciate working in Rhino is its simplicity in creating organic forms. For this segment of the assignment, I sketched my own base shape using the Curve command. After adding notches to my design, I proceeded to cut it out with the laser cutter. I'm really fond of the final design! It had a sense of fun and whimsy, which was precisely my intent. It also resembles a group of animals feeding, which I really enjoy!.</p>        </div>
      <div className={styles.subcard2}>
      </div>
      </div>
      <style jsx>{`
